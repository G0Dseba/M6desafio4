...
class PhotographsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create photograph" do
    assert_difference("Photograph.count") do
      post photographs_url, params: { photograph: { description: @photograph.description, image: @photograph.image, title: @photograph.title, user_id: @photograph.user_id } }
    end
  ...
  test "should update photograph" do
    patch photograph_url(@photograph), params: { photograph: { description: @photograph.description, image: @photograph.image, title: @photograph.title, user_id: @photograph.user_id } }
